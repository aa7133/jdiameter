...
public class T6aSessionBasicFlowClientCMRTest {
  private ClientSendCMR clientNode;
  private ServerRecvCMR serverNode1;
  ...
  public void setUp() throws Exception {
    try {
      this.clientNode = new ClientSendCMR();
      this.serverNode1 = new ServerRecvCMR();
  ...
  public void testConfigurationInformation() throws Exception {
    try {
      ...
      clientNode.sendConnectionManagementRequest();
      waitForMessage();

      serverNode1.sendConnectionManagementAnswer();
      waitForMessage();
    }
    catch (Exception e) {
      e.printStackTrace();
  ...
  public static Collection<Object[]> data() {
    ...
    Class<T6aSessionBasicFlowClientCMRTest> t = T6aSessionBasicFlowClientCMRTest.class;
