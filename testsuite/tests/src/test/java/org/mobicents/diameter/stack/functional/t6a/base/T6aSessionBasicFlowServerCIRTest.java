...
public class T6aSessionBasicFlowServerCIRTest {
  private ClientRecvCIR clientNode;
  private ServerSendCIR serverNode1;
  private URI clientConfigURI;
  private URI serverNode1ConfigURI;

  public T6aSessionBasicFlowServerCIRTest(String clientConfigUrl, String serverNode1ConfigURL) throws Exception {
    super();
  ...
  public void setUp() throws Exception {
    try {
      this.clientNode = new ClientRecvCIR();
      this.serverNode1 = new ServerSendCIR();
  ...
  public void testConfigurationInformation() throws Exception {
    try {
      ...
      serverNode1.sendConfigurationInformationRequest();
      waitForMessage();

      clientNode.sendConfigurationInformationAnswer();
      waitForMessage();
    }
    catch (Exception e) {
      e.printStackTrace();
  ...
  public static Collection<Object[]> data() {
    ...
    Class<T6aSessionBasicFlowServerCIRTest> t = T6aSessionBasicFlowServerCIRTest.class;
